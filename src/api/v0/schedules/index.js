...
export const schedule = async (id) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/${id}`, {
            method: 'GET',
            headers: {
...
export const deleteScheduleAdmin = async (id, token, free) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/bookings/admin/${id}`, {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const assistance = async (token, id) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/assistance/${id}`, {
            method: 'PATCH',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const deleteSchedule = async (id, token) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/bookings/${id}`, {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const searchBookingClient = async (token, id, query) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/bookings/search/${id}/${query}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const getBookingClient = async (token, id, page) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/bookings/client/${id}?page=${page}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const createBooking = async (token, schedule, seat, client, isPass) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/${schedule}/seat/${seat}/client/${client}`, {
            method: 'POST',
            body: JSON.stringify(body),
            headers: {
                'Accept': 'application/json',
...
export const createBookingClient = async (token, schedule, seat, isPass) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/${schedule}/seat/${seat}`, {
            method: 'POST',
            body: JSON.stringify(body),
            headers: {
                'Accept': 'application/json',
...
export const createBookingGroup = async (token, schedule, seat, client) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/${schedule}/seat/${seat}/client/${client}/member`, {
            method: 'POST',
            body: JSON.stringify(body),
            headers: {
                'Accept': 'application/json',
...
export const createBookingGroupAdmin = async (token, schedule, seat, client) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/${schedule}/seat/${seat}/member`, {
            method: 'POST',
            body: JSON.stringify(body),
            headers: {
                'Accept': 'application/json',
...
export const getBookingListAdmin = async (token, id) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/bookings/list/${id}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const getAllSchedules = async (token, page) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/locations/schedules/all/?page=${page}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const searchOnAllSchedules = async (token, query) => {
    try {
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/search/${query}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export const createSchedule = async (token, date, start, end, instructor, room, theme, isPrivate) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/create`, {
            method: 'POST',
            body: JSON.stringify(body),
            headers: {
                'Accept': 'application/json',
...
export const updateSchedule = async (token, id, date, start, end, instructor, theme, room, sendEmail, freeSeats, isPrivate) => {
    try {
        ...
        const response = await fetch(`${Constants.API.BASE_URL}/schedules/update`, {
            method: 'PATCH',
            body: JSON.stringify(body),
            headers: {
                'Accept': 'application/json',
