...
<input value={state.discountCode} onChange={(e) => setState({ ...state, discountCode: e.target.value })} />
        ...
        <div className="p-d-flex p-jc-center p-ai-center">
          <Button label="Clásicos" style={{ backgroundColor: '#6a756d', color: '#fff', borderRadius: 50, border: 'none', marginRight: 10, width: 150 }} onClick={() => {
            setShowSpecial(false)
            setShowGrupal(false)
            setShowFlow(false)
          }} />
          {state.specialBundles.length > 2 && <Button label="Especiales" style={{ backgroundColor: '#6a756d', color: '#fff', borderRadius: 50, border: 'none', width: 150, marginRight: 10 }} onClick={() => {
            setShowSpecial(true)
            setShowFlow(false)
            setShowGrupal(false)
          }} />}
          {state.groupBundles.length > 2 && allowGrupal && <Button label="Grupales" style={{ backgroundColor: '#6a756d', color: '#fff', borderRadius: 50, border: 'none', width: 150 }} onClick={() => {
            setShowSpecial(false)
            setShowFlow(false)
            setShowGrupal(true)
          }} />}
