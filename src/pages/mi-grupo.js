                    ...
                    <div className="p-grid p-align-center">
                        <div className="p-col-12" style={{ position: 'relative' }}>
                            <Button
                                ...
                                className="p-button"
                                disabled={!edited}
                                style={{ width: "auto", position: 'fixed', right: 30, top: 20, color: 'white', borderRadius: 10, backgroundColor: '#3eb978', border: 'none', transition: '300ms linear all', transform: edited ? "translateY(0px)" : "translateY(-100px)" }}
                                onClick={() => {
                                    updateName()
                                }}
                            />
