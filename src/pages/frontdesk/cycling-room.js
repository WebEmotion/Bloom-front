          ...
          >
            ...
            seats.length > 0 &&  <div className='p-col-10' style={{ zIndex: 10 }}>
              <div className="p-row">
                ...
                />
                <Button
                  style={{ margin: "3px 20px 3px 0px", backgroundColor: '#d78676', borderColor: '#d78676', border: selectedGroup ? '6px solid #495057' : '' }}
...

                    {
                      [1, 2, 3, 4, 5, 6, 7, 8, 9].map(n => (
                        <Button
                          ...
                          badge={selected && selected.name === `C${n}` ? "✓" : selectedPasses && selectedPasses.name === `C${n}` ? "✓" : selectedGroup && selectedGroup.name === `C${n}` ? "✓" : ""}
