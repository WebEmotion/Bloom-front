  ...
  return (
    <div>
      <div 
        ...
        style={{ 
          backgroundColor: forbidden && isReserved ? '#6e6666' : forbidden ? '#E6CDB5' : disabled ? '#00000020' : isReserved ? '#6e6666' : now >= end ? '#00000020' : !havePackage && !canReservate ? '#E6CDB5' : '#E6CDB5', 
