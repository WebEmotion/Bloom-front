            ...
            <Layout page="Aviso de Privacidad">
                ...
                <div className="p-grid p-align-center p-justify-center">
                    <div className="p-col-12 p-md-10" style={{ textAlign: "justify" }}>
                        ...
                        <p>El responsable de la protección de sus datos personales es BLM Cycling Studio según el Estudio de que se trate, con domicilio común ubicado en Jorge Jimenez Cantu SN L8 complejo La Antigua 2, Bosque Esmeralda, 52938 Cd López Mateos, Méx. y puede contactarnos a través del número telefónico +52 55 8051 0715.</p>

                        <p>Sus datos personales serán utilizados para las siguientes finalidades:</p>
                        <ul>
                            <li>Proveer los servicios y productos requeridos por usted.</li>
                            <li>Informar sobre cambios o nuevos productos o servicios relacionados con el contratado o adquirido por el cliente.</li>
